...
Source: https://gallica.bnf.fr/ark:/12148/bpt6k852354j/f296.item
...
| `c1-l021` | &emsp;*molheres, que ſeruem ao Dairi.* |  |
...
| `c1-l033` | &emsp;*& de noite.* |  |
| `c1-l034` | Iǔnino tebaco. *Caixa, ou boceta de molhe-* |  |
| `c1-l035` | &emsp;*res que tem doze bocetas dentro, ſeis a hũa* |  |
| `c1-l036` | &emsp;*parte, & ſeis a outra.* |  |
| `c1-l037` | Iǔniqei. *Doze veas que ha nos pès, & nas* |  |
| `c1-l038` | &emsp;*mãos de que falão os medicos. Vt,* Iǔniqei, |  |
| `c1-l039` | &emsp;jǔgoracu. *Vide* Iugoracu. |  |
| `c1-l040` | Iunjucu. i, Vagǒ ſuru. *Vnirſe em amizade* |  |
| `c1-l041` | &emsp;*ou no meſmo parecer, &c.* |  |
| `c1-l042` | Iǔnixǒ. *Doze tribus, ou 12. Familias: pala-* |  |
| `c1-l043` | &emsp;*ura que não ha propriamente em Iapão, mas* |  |
| `c1-l044` | &emsp;*vſa ſe nos liuros da Igreja.* |  |
| `c1-l045` | Iunni. *Ordenadamente, ou por ordem, ou* |  |
| `c1-l046` | &emsp;*rectamente. ¶* Sacazzuqiuo junni ma- |  |
| `c1-l047` | &emsp;uaſu. *Correr com o Sacazzuqui à roda hum* |  |
| `c1-l048` | &emsp;*por hum.* |  |
...
| `c2-l007` | &emsp;pǔni fouo fiqu, l, caquru. *Dar a vela* |  |
| `c2-l008` | &emsp;*com vento a popa.* |  |
| `c2-l009` | Iunquai. i, Iunno quai. *O conuidar a mui-* |  |
| `c2-l010` | &emsp;*tos de diuerſo grao, & dignidade correndo to* |  |
| `c2-l011` | &emsp;*dos pouco a pouco por ſua ordẽ, & por ſua vez.* |  |
| `c2-l012` | Iunquan. Xitagai meguru. *Rodear. Vt,* |  |
| `c2-l013` | &emsp;Tenno junquan. *Reuolução dos ceos.* |  |
| `c2-l014` | &emsp;*¶ Item, O correr o ſangue liuremente pellas* |  |
...
| `c2-l030` | Iuntacuni. *Adu.* |  *(materiaes.* |
...
| `c2-l035` | &emsp;*¶* Iunxina fito. *Homem recto, & ordenado.* |  |
| `c2-l036` | Iunxocu. *Cor freſca, ou freſquidão. Tomaſe* |  |
| `c2-l037` | &emsp;*por graça, ou beneficio, que vem do ceo, ou* |  |
| `c2-l038` | &emsp;*dalgũa peßoa alta. S.* |  |
| `c2-l039` | Iunyen. Xitagǒ yen. *Liãça, ou combinação* |  |
| `c2-l040` | &emsp;*de que hum he leuado. ¶ Item, Obras q̃* |  |
| `c2-l041` | &emsp;*deſi direitamente são boas, & bem ordenadas.* |  |
| `c2-l042` | Iuqiô. Qiôni iru. *O ter goſto, ou prazer* |  |
| `c2-l043` | &emsp;*dalgũa couſa. ¶* Iuqiôno amarini aſobi |  |
| `c2-l044` | &emsp;tauamururu. *Folgar, & deſenfadarſe eſtã-* |  |
| `c2-l045` | &emsp;*do com demaſiado goſto, & prazer.* |  |
| `c2-l046` | Iuqiô. i, Iuxano voxiye. *Doctrina moral q̃* |  |
| `c2-l047` | &emsp;*certos Philoſophos da China enſinão.* |  |
