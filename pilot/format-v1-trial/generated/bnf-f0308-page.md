...
Source: https://gallica.bnf.fr/ark:/12148/bpt6k852354j/f308.item
...
| Physical line | Main position | Far right |
| --- | --- | --- |
| `c1-l001` | &emsp;*Cordão da Catana tecido, & feitotodo redõdo.* |  |
...
| `c1-l025` | &emsp;Maſaxiſa. |  |
| `c1-l026` | &emsp;Maſaxǔ, l, maſaxiqu. |  |
| `c1-l027` | Maſotto. *Adu. Mais hum pouco.* |  |
| `c1-l028` | Maſſacari. *Flor, ou vigor da idade, &c.* |  |
| `c1-l029` | &emsp;*¶* Fanano maſsacari. *Tempo em que to-* |  |
| `c1-l030` | &emsp;*das as roſas, ou fulas florecem.* |  |
| `c1-l031` | Maſſacaſama. *Totalmente às aueſſas.* |  |
| `c1-l032` | Maſsacaſamani. *Totalmente às asaueßas, ou* |  |
| `c1-l033` | &emsp;*de cabeça pera baixo. ¶* Maſſacaſamani |  |
...
| `c1-l041` | &emsp;*ya era conjunção em que o Feique, & Guenji* |  |
| `c1-l042` | &emsp;*eſtauão no meo, ou fragrante da batalha.* |  |
| `c1-l043` | &emsp;*¶* Fuyuno maſſaichù. *Meo, ou coração* |  |
| `c1-l044` | &emsp;*do Inuerno.* |  |
| `c1-l045` | Maſſaqi. *Muito diante. ¶* Maſſaqini ſu- |  |
| `c1-l046` | &emsp;ſumu. *Tomar a dianteira. ¶* Maſſaqi |  |
| `c1-l047` | &emsp;uo caquru. *Ir nadianteira. Vt,* Qimi |  |
...
| `c2-l006` | &emsp;*Eſtar muito perto dalguem.* |  |
| `c2-l007` | Maſsono. *Vt,* Maſſono vaqini. *Na bor-* |  |
| `c2-l008` | &emsp;*dinha. ¶* Maſſono ſoba, maſsono atari. |  |
| `c2-l009` | &emsp;*Alli muito perto, ou junto.* |  |
...
| `c2-l024` | &emsp;*pernas. Vt,* Te axino mata. *Abertura.* |  |
| `c2-l025` | &emsp;*dantre os dedos das mãos, & dos pees.* |  |
| `c2-l026` | Matabiquan. *Criado de outro criado.* |  |
| `c2-l027` | Mataburi. *Hum pao como forcado com q̃ me-* |  |
| `c2-l028` | &emsp;*tem lenha no forno os que fazem ſal, &c.* |  |
| `c2-l029` | Matagari, u, atta. *Estar com as pernas, ou* |  |
| `c2-l030` | &emsp;*pees largos eſtendidos. ¶* Monni mataga- |  |
| `c2-l031` | &emsp;ru. *Porſe à porta com os pees largos, & fei* |  |
| `c2-l032` | &emsp;*ção de não deixar entrar a ninguem.* |  |
...
| `c2-l046` | &emsp;*de mezinha.* |  |
| `c2-l047` | Matataqi. *Em abrindo, & fechando o olho.* |  |
| `c2-l048` | &emsp;*¶* Matataqino aida. *Em quanto ſe abrẽ,* |  |
