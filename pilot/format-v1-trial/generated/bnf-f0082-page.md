...
| Physical line | Main position | Far right |
| --- | --- | --- |
| `c1-l001` | Canatçuqi. *Fiſga de ferro.* |  |
...
| `c1-l020` | &emsp;*ro. B.* |  |
| `c1-l021` | Canaxiuo. T*empera de ferro.* |  |
...
| `c1-l027` | &emsp;*ſejos dalguem. ¶* Soxôuo canayuru. *Cõ-* |  |
...
| `c1-l034` | Canban. Fuda ita. T*aboa vruxada, ou pa-* |  |
...
| `c1-l041` | Canbat. i. Fideri. *Seca.* |  |
| `c1-l042` | Canbaxe. *Reſto.* |  |
| `c1-l043` | Canbaxij. *Couſa cheiroſa.* |  |
| `c1-l044` | &emsp;Canbaxiſa. |  |
| `c1-l045` | &emsp;Canbaxù. |  |
| `c1-l046` | Canben. Cangaye vaqimayuru. *Conſide-* |  |
| `c1-l047` | &emsp;*ração.* |  |
| `c1-l048` | Canbeǒ, l, cabeǒ. *O curar doentes.* |  |
...
| Physical line | Main position | Far right |
| --- | --- | --- |
| `c2-l001` | Canbǒ. i. Bõzo. *Que tem cuidado dalgũa* |  |
| `c2-l002` | &emsp;Tera*.* |  |
...
| `c2-l010` | &emsp;*mariſco, a bobora, &c.* |  |
...
| `c2-l021` | &emsp;*por onde conjeiturão os que a diuinhão em* |  |
| `c2-l022` | &emsp;*Iapão.* |  |
...
| `c2-l042` | Candǒ. i. Nuqijirono mon. *Lauor con o ro* |  |
| `c2-l043` | &emsp;*ſa, ou folhagem de peça tecida de fio verme-* |  |
| `c2-l044` | &emsp;*lho, & branco.* |  |
| `c2-l045` | Candǒ. Xizzucana michi. i. Buji. *Paz.* |  |
| `c2-l046` | Candǒ. Vaqimichi. i. Sobamichi. *Ata* |  |
