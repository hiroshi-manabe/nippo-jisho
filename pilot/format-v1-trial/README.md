...
The corpus represents 189 complete pages in the adopted compact human-readable Level 1 authoring format. The six-page, 526-line adoption baseline has been extended by 183 sequential production pages, bringing the compiler-validated total to 18,462 physical lines. Seven structural assertions and eight selected reading sequences remain as a secondary compatibility check, not the current design focus.
...
The 189 complete page records contain 18,462 physical lines. Exact source-image SHA-256 values are stored in each Level 1 page record.
...
- [`../human-review/README.md`](../human-review/README.md) documents the dictionary-wide generated review shell and the line-by-line checkpoint for all 179 Level 1 pages.
...
- All 189 complete pages can be read directly as Markdown while compiling back to the complete 18,462-line machine representation.
- The 189 authoring files occupy 24,567 lines and 1,011,118 bytes, compared with 241,487 lines and 5,421,914 bytes for the generated pretty-printed JSON.
