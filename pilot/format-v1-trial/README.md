...
The corpus represents 219 complete pages in the adopted compact human-readable Level 1 authoring format. The six-page, 526-line adoption baseline has been extended by 213 sequential production pages, bringing the compiler-validated total to 21,399 physical lines. Seven structural assertions and eight selected reading sequences remain as a secondary compatibility check, not the current design focus.
...
The 219 complete page records contain 21,399 physical lines. Exact source-image SHA-256 values are stored in each Level 1 page record.
...
- All 219 complete pages can be read directly as Markdown while compiling back to the complete 21,399-line machine representation.
