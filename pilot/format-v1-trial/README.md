...
| `bnf-f0158`–`bnf-f0167` | Complete dictionary text and textual furniture | Ten-page normal bounded batch, transition from D into F, scan-authoritative NINJAL diagnostics, internal-section and complete-initial geometry audit, recto/verso furniture review |
| `bnf-f0168`–`bnf-f0177` | Complete dictionary text and textual furniture | Ten-page normal bounded batch, F vocabulary, scan-authoritative NINJAL diagnostics, physical-line geometry audit, recto/verso furniture review |
| `bnf-f0178`–`bnf-f0187` | Complete dictionary text and textual furniture | Ten-page normal bounded batch, F vocabulary, scan-authoritative NINJAL diagnostics, internal-section and complete-initial geometry audit, recto/verso furniture review |
| `bnf-f0188`–`bnf-f0197` | Complete dictionary text and textual furniture | Ten-page normal bounded batch, F vocabulary, Gallica-URL NINJAL assignment after numbering divergence, anomalous-header and displaced-continuation geometry review |
| `bnf-f0198`–`bnf-f0207` | Complete dictionary text and textual furniture | Ten-page normal bounded batch, transition from `FI` into `FO`, Gallica-URL NINJAL diagnostics, internal-section and continuation geometry review |
| `bnf-f0208`–`bnf-f0217` | Complete dictionary text and textual furniture | Ten-page normal bounded batch, transition from `FO` into `FV`, Gallica-URL NINJAL diagnostics, internal-section and complete-initial geometry review |
| `bnf-f0218`–`bnf-f0227` | Complete dictionary text and textual furniture | Ten-page normal bounded batch, `FV` vocabulary, Gallica-URL NINJAL diagnostics, low-baseline correction and missing-leaf witness audit |
...
Pages `f128`–`f137` add 983 physical lines and represent all 447 NINJAL rows assigned to those leaves as a post-draft coverage diagnostic. The batch continues from f127's displaced `ji-`, preserves the internal f135 `C ANTES DO V.` transition and anomalous running-header changes, and leaves f137's final `ſobre` as an ordinary continuation into the next leaf. A native-scan remeasurement of f131–f135 subsequently corrected cumulative drift, clipped initials, low final rows, and f135 column 2's one-row phase error; its accompanying text pass corrected concentrated vowel-mark errors without treating NINJAL as transcription authority. All twenty contact sheets were inspected before geometry was marked reviewed. The pages remain review-ready drafts pending independent human correction.
...
Pages `f158`–`f167` add 978 physical lines and represent all 413 NINJAL rows assigned to those leaves as a post-draft coverage diagnostic. The batch finishes D and enters F on f160, preserving its three-line transition heading and complete decorated initial; it also retains f164's printed mismatch between `F ANTES DO O.` and `F ANTES DO A.` and two physically displaced right-edge fragments. All twenty contact sheets were inspected and page-specific baseline offsets were corrected before geometry was marked reviewed. The pages remain review-ready drafts pending independent human correction.

Pages `f168`–`f177` add 984 physical lines and represent all 407 NINJAL rows assigned to those leaves as a post-draft coverage diagnostic. The batch continues the F vocabulary, preserving printed catchword fragments, alternating recto furniture, and physically separated marginal text. All twenty contact sheets were inspected before geometry was marked reviewed. The pages remain review-ready drafts pending independent human correction.

Pages `f178`–`f187` add 980 physical lines and represent all 353 NINJAL rows assigned to those leaves as a post-draft coverage diagnostic. The batch continues the F vocabulary and preserves internal alphabetical transitions on f181 and f186, source anomalies and displaced fragments, and the distinction between ordinary bottom-line continuations and catchwords. Complete-glyph crop overrides retain the enlarged `FE.` and `FI.` initials. All twenty contact sheets were inspected before geometry was marked reviewed. The pages remain review-ready drafts pending independent human correction.

Pages `f188`–`f197` add 981 physical lines and represent all 334 NINJAL rows assigned by Gallica URL to those leaves as a post-draft coverage diagnostic. The batch continues the F vocabulary, preserves f194's anomalous `ANTE DOI.` header, and retains displaced bottom continuations on f194–f197 in physical order. At f191 the NINJAL internal leaf number begins to diverge from the canonical Gallica f-number, so coverage assignment follows the dataset's Gallica URL field. All twenty contact sheets were inspected before geometry was marked reviewed. The pages remain review-ready drafts pending independent human correction.
...
Pages `f218`–`f227` add 978 physical lines and represent all 364 NINJAL rows assigned by Gallica URL to those leaves as a post-draft coverage diagnostic. The batch continues the `FV` vocabulary and preserves the source witness's jump from printed page 109 to printed page 112 rather than treating the missing leaves as a transcription omission. Geometry review corrected low first baselines on f218, f226, and f227, and low final baselines on f226 and f227. All twenty contact sheets were inspected before geometry was marked reviewed. The pages remain review-ready drafts pending independent human correction.

Pages `f228`–`f237` add 981 physical lines and represent all 376 NINJAL rows assigned by Gallica URL to those leaves as a post-draft coverage diagnostic. The batch completes F, preserves the internal G-section heading and decorated initial on `f230`, and reaches the change from `G ANTES DO E.` to `G ANTES DO I.` on `f237`. All twenty contact sheets were inspected before geometry was marked reviewed. The pages remain review-ready drafts pending independent human correction.
...
- The compatible `initial=N` annotation preserves twenty-three recurring enlarged section initials without joining the following physical line or burdening ordinary lines with extra markup; the decorated `B` on f47 spans four lines while ordinary enlarged initials span two.
