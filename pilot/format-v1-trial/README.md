...
The corpus represents 179 complete pages in the adopted compact human-readable Level 1 authoring format. The six-page, 526-line adoption baseline has been extended by 173 sequential production pages, bringing the compiler-validated total to 17,481 physical lines. Seven structural assertions and eight selected reading sequences remain as a secondary compatibility check, not the current design focus.
...
The 179 complete page records contain 17,481 physical lines. Exact source-image SHA-256 values are stored in each Level 1 page record.
...
- All 179 complete pages can be read directly as Markdown while compiling back to the complete 17,481-line machine representation.
- The 179 authoring files occupy 23,281 lines and 956,561 bytes, compared with 228,821 lines and 5,136,127 bytes for the generated pretty-printed JSON.
