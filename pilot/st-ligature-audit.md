...
The complete pre-rewrite inventory and positive-decision ledger were retired after this task. Git history and Issues #45–#47 preserve them as provenance, while the accepted results remain in the canonical transcription. A future pass must generate a fresh inventory from current text and geometry rather than restoring the old candidate state.
