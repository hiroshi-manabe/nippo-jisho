...
"""
    ...
    def test_public_corpus_exposes_ocr_candidates_without_promoting_them(self):
        ...
        expected_supplements = json.loads((ROOT / 'sources/supplemental-pages.json').read_text())['pages']
        self.assertEqual({p['page_id'] for p in supplements}, {p['id'] for p in expected_supplements})
        ...
        for page in corpus["pages"]:
            if page["processed"]:
                self.assertRegex(page["baseline_commit"], r"^[0-9a-f]{40}$")
                self.assertIn("T", page["baseline_updated_at"])
...
"""
    ...
    def test_automatic_kana_guide_is_build_generated_and_dictionary_aware(self):
        ...
        self.assertEqual(transliterate_token("vaqete"), "ワケテ")
        self.assertEqual(transliterate_token("Vaga"), "ワガ")
        self.assertEqual(transliterate_token("vonaji"), "オナジ")
        self.assertEqual(transliterate_token("vgoqu"), "ウゴク")
        ...
        self.assertEqual(transliterate_token("Fagi"), "ハヂ")
        self.assertEqual(transliterate_token("ji"), "ジ")
        self.assertEqual(transliterate_token("zu"), "ズ")
        self.assertEqual(transliterate_token("zzu"), "ヅ")
        self.assertEqual(transliterate_token("mizzu"), "ミヅ")
        self.assertEqual(transliterate_token("mizzuuo"), "ミヅヲ")
        self.assertEqual(transliterate_token("Zzǔ"), "ヅゥ")
        self.assertEqual(transliterate_token("Fagiuo"), "ハヂヲ")
        self.assertEqual(transliterate_token("Fagui"), "ハギ")
        self.assertEqual(transliterate_token("gigocu"), "ヂゴク")
        ...
        self.assertEqual(transliterate_token("Quacuran"), "クヮクラン")
        self.assertEqual(transliterate_token("Chinqua"), "チンクヮ")
        self.assertEqual(transliterate_token("Guaxin"), "グヮシン")
        self.assertEqual(transliterate_token("Nhôjet"), "ニョゥゼッ")
        self.assertEqual(transliterate_token("Nhôjetna"), "ニョゥゼッナ")
        ...
        self.assertEqual(transliterate_token("Reǒginno"), "リョゥヂンノ")
        self.assertEqual(transliterate_token("Reôri"), "リョゥリ")
        self.assertEqual(transliterate_token("Riǒ"), "リョゥ")
        self.assertEqual(transliterate_token("Meǒji"), "ミョゥジ")
        self.assertEqual(transliterate_token("reo"), "レオ")
        self.assertEqual(transliterate_token("ichinifiacqizzutçu"), "イチニヒャッキヅツ")
        self.assertEqual(transliterate_token("fiacqi"), "ヒャッキ")
        self.assertEqual(transliterate_token("mocco"), "モッコ")
        self.assertEqual(transliterate_token("cocca"), "コッカ")
        self.assertEqual(transliterate_token("coco"), "ココ")
