...
The [missing-leaf supplementation plan](docs/missing-leaf-supplementation.md)
maps Bodleian scans for all seven missing folio pairs and prepares them as
separately attributed, AI-unreviewed OCR drafts.
